...
class _EditImageScreenState extends EditImageViewModel {
                  ...
                  for (var element in texts)
                    Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () => setCurrentIndex(context, texts.indexOf(element)),
                        child: Draggable(
                          feedback: ImageText(textInfo: element),
                          child: ImageText(textInfo: element),
                          onDragEnd: (drag) {
                            final renderBox =
                                context.findRenderObject() as RenderBox;
                            Offset off = renderBox.globalToLocal(drag.offset);
                            setState(() {
                              element.top = off.dy - 96 - (context.height * 0.25);
                              element.left = off.dx;
                            });
                          },
                        ),
  ...
  FloatingActionButton get _addNewTextFab => FloatingActionButton(
